...
var AudioPlayer = (function() {
    ...
    '          <i style="color:black" class="fas fa-step-backward"></i>'+
    '        </button>'+
    '        <button class="ap-controls ap-toggle-btn">'+
    '            <i style="color:black" class="fas fa-play"></i>'+
    '            <i style="color:black" class="fas fa-pause"></i>'+
    '        </button>'+
    '        <button class="ap-controls ap-next-btn">'+
    '          <i style="color:black" class="fas fa-step-forward"></i>'+
    '        </button>'+
    '      </div>'+
    ...
    '              <i style="color:black" class="fas fa-volume-up"></i>'+
    '              <i style="color:black" class="fas fa-volume-down"></i>'+
    '          </button>'+
    '          <div class="ap-volume">'+
    ...
    '          <i style="color:black" class="fas fa-redo"></i>'+
    '        </button>'+
    '        <button class="ap-controls ap-playlist-btn">'+
    '          <i style="color:black" class="fas fa-share-square"></i>'+
    '        </button>'+
    '      </div>'+
    '    </div>'+
    '  </div>';
  ...
  plLi,
      tplList =
          '<li class="pl-item" data-track="{count}">'+
          '<div class="pl-number">'+
          '<div class="pl-count">'+
 ...
 */
    function renderPL() {
      var html = [];
      var tpl =
        '<li classname="pl-item" data-track="{count}">'+
          '<div class="pl-number">'+
            '<div class="pl-count">'+
              '<i class="fas fa-music"></i>'+
            '</div>'+
